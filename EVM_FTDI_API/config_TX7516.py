...
# pattern = [0xC8C80500, 0xB5B10000, 0x0500B5B1, 0xFF00C8C8]
...
# e.g. 0xC8C80500, 0xB5B10000, 0x0500B5B1, 0xFF00C8C8
#      sequence: 00 -> GLB_REP_NUM
#                05 -> LOCAL_REP_NUM = 5
#                C8 -> PER1 = 25; LVL1 = 000 -> 25 cycles of GND
#                C8 -> PER2 = 25; LVL2 = 000 -> 25 cycles of GND
#                00 -> LOCAL_REP_END -> This pattern means 6*50 cycles of GND
#                00, B1, B5, B1, B5, 00 -> 2 cycles of 5.6MHz 3LVL_A wave
#                05, C8, C8, 00 -> 6*50 cycles of GND
#                FF -> GLB_REP_END
