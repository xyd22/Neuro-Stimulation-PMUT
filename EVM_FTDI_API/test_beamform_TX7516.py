...
if __name__ == "__main__":
	...
	parser.add_argument('-a', '--angle', help='beamforming angle index, from 0 to 60 corresponding to -30 to 30 degree', default=0)
	args = parser.parse_args()
	theta = int(args.angle)
	...
	# Choose the delay
	delay = all_delay_hex_values[theta]
	
	# Convert hex strings to integers only if they are not already integers
	delays_int = [value if isinstance(value, int) else int(value, 16) for value in delay]
	
	print("Starting main program for delay set index:", theta)
	...
	print("==========================================================")		
	print("Processing delay set for angle index {}, angle {}".format(theta, theta - 30))		
	print("==========================================================")		
	...
	print("Finished sending signal for delay set index:", theta)
	...
	print("Finished processing signal for delay set index:", theta)
